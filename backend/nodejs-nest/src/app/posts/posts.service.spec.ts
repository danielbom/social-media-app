...
describe('PostsService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [PostsService, { provide: getRepositoryToken(Post), useValue: postRepository }],
    }).compile()
  ...
  describe('PostsService.update', () => {
    it('should works', async () => {
      ...
      service.findOneByAuthor = vi.fn(service.findOneByAuthor).mockImplementationOnce(async () => previousPost)
  ...
  describe('PostsService.remove', () => {
    it('should works', async () => {
      ...
      service.findOneByAuthor = vi.fn(service.findOneByAuthor).mockImplementationOnce(async () => post)
