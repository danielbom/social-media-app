...
export class PostsController {
  ...
  @Post()
  create(@Body() createPostDto: CreatePostDto, @AuthUser() user: User): Promise<EPost> {
  ...
  @Patch(':id')
  update(@Param('id') id: Uuid, @Body() updatePostDto: UpdatePostDto, @AuthUser() user: User): Promise<EPost> {
